  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', padding: '0 24px' }}>
        ...
        >
          The first public opinion platform that shows you the gap between what people say - and what
        ...
        >
          <div style={{ textAlign: 'left' }}>
            ...
            <div style={{ fontFamily: 'var(--font-display)', fontSize: 22, color: 'var(--gold)', fontWeight: 600 }}>
              The Truth Gap (TM)
            </div>
          </div>
          ...
          <div style={{ fontSize: 13, color: 'var(--text-muted)', textAlign: 'left', maxWidth: 280, lineHeight: 1.6 }}>
            The % divergence between what <span style={{ color: 'var(--text)' }}>everyone says</span> and what{' '}
            <span style={{ color: 'var(--teal)' }}>verified humans</span> actually believe.
          </div>
        </div>
      </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        maxWidth: 260,
        padding: '32px 24px',
        background: highlighted ? `rgba(201,168,76,0.06)` : 'rgba(10,12,26,0.7)',
